...
def FullOTA_InstallEnd(info):
  ...
  info.script.AppendExtra('ifelse(is_substring("R970C", getprop("ro.bootloader")), run_program("/sbin/sh", "-c", "busybox cp -R /system/proprietary/cri/* /system/"));')
  info.script.AppendExtra('ifelse(is_substring("R970X", getprop("ro.bootloader")), run_program("/sbin/sh", "-c", "busybox cp -R /system/proprietary/csp/* /system/"));')
